...
public class controllerCity extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           if(request.getParameter("registrCity")!= null){
               user.insertMuni(nombre,descripcion,kilometros,telefono,fecha,subregion);
